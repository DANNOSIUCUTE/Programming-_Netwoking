...
# Cấu hình chung
SERVER_IP = "192.168.1.8"  # Cập nhật lại theo IP của server
SERVER_PORT = 12345
TOTAL_CHUNKS = 4         # Số kết nối/chunk theo yêu cầu đồ án
CHUNK_TIMEOUT = 3        # Timeout cho việc nhận các segment của 1 chunk (đã tăng lên)
MAX_RETRIES = 5
...
class DownloadClient:
    ...
    def download_file(self, filename):
        ...
        # Mở cửa sổ để hiển thị tiến độ tải từng chunk
